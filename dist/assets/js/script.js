...
jQuery(function ($) {
  ...
  $("#js-submit").on("click", function () {
    ...
    if ($(".errored").length > 0 || radioChecked === 0 || $("#pull-down").val() === "" || checkboxChecked === 0 || !emailRegex.test(emailInput) || !nameRegex.test(nameInput) || !phoneNumberRegex.test(phoneNumberInput)) {
