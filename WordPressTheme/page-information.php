    ...
    <section class="sub-fv">
        <div class="sub-fv__inner">
            ...
            <picture class="sub-fv__image">
                <source srcset="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-information__fv-pc.jpg')); ?>" media="(min-width: 768px)">
                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-information__fv-sp.jpg')); ?>" alt="海中のダイバーと黄色い魚の画像">
            </picture>
        </div>
    </section>
    <!-- パンくずリスト -->
                    ...
                    <ul class="tab-contents__items">
                        <li class="tab-contents__item js-tab-target is-active" id="tab1-content">
                            ...
                            <figure class="tab-contents__image">
                                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-information__license.jpg')); ?>" alt="海に浮かぶダイバーたちの画像">
                            </figure>
                        </li>
                        <li class="tab-contents__item js-tab-target" id="tab2-content">
                            ...
                            <figure class="tab-contents__image">
                                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-information__fundiving.jpg')); ?>" alt="小魚の大群の画像">
                            </figure>
                        </li>
                        <li class="tab-contents__item js-tab-target" id="tab3-content">
                            ...
                            <figure class="tab-contents__image">
                                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-information__diving.jpg')); ?>" alt="二匹の黄色い魚の画像">
                            </figure>
                        </li>
                    </ul>
                </div>
