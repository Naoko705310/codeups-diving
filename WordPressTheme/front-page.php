                ...
                <div class="swiper campaign__swiper js-campaign-swiper">
                    <div class="swiper-wrapper campaign__swiper-wrapper">
                        ...
                        foreach ($campaign_posts as $post) : setup_postdata($post);
                            ?>
                            <div class="swiper-slide">
                                <a href="<?php echo esc_url(get_post_type_archive_link('campaign')); ?>" class="campaign-card">
                                    ...
                                    <div class="campaign-card__body">
                                        ...
                                        <div class="campaign-card__plan">
                                            <p class="campaign-card__text"><?php echo esc_html(get_field('campaign-price_title')); ?></p>
                                            <div class="campaign-card__price-wrapper">
                                                <p class="campaign-card__old-price">¥<?php echo esc_html(get_field('price_previous')); ?></p>
                                                <p class="campaign-card__new-price">¥<?php echo esc_html(get_field('price_new')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
            ...
            <div class="about-us__contents-wrapper">
                <div class="about-us__image-wrapper">
                    <figure class="about-us__image-left">
                        <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/aboutus-01.jpg')); ?>" alt="シーサーの画像">
                    </figure>
                    <figure class="about-us__image-right">
                        <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/aboutus-02.jpg')); ?>" alt="黄色い魚の画像">
                    </figure>
        ...
        <div class="information__inner inner">
            ...
            <div class="information__contents-wrapper">
                <figure class="information__image colorbox">
                    <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/information-01.jpg')); ?>" alt="サンゴと黄色い魚の画像">
                </figure>
                ...
                <?php if ($blog_posts->have_posts()) : ?>
                    ...
                    <a href="<?php the_permalink(); ?>" class="blog-cards__item blog-card">
                        <figure class="blog-card__image">
                            ...
                            <?php else : ?>
                                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/blog-card-01.jpg')); ?>" alt="デフォルト画像">
                            <?php endif; ?>
                        </figure>
                        <div class="blog-card__body">
                            <time class="blog-card__time" datetime="<?php echo esc_attr(get_the_time('c')); ?>"><?php echo esc_html(get_the_time('Y.m.d')); ?></time>
    ...
    <section id="voice" class="voice top-voice">
        <div class="voice__inner inner">
            ...
            <div class="voice__items voice-cards">
                ...
                ?>
                    <a href="<?php echo esc_url(get_post_type_archive_link('voice')); ?>" class="voice-cards__item voice-card">
                        <div class="voice-card__header-wrapper">
                            <div class="voice-card__header">
                                <div class="voice-card__information">
                                    <p class="voice-card__age">
                                        <?php echo esc_html(get_field('age')); ?> <!-- 年齢や性別などのフィールド -->
                                    </p>
        ...
        <div class="price__inner inner">
            ...
            <div class="price__contents-wrapper">
                ...
                <picture class="price__image colorbox">
                    ...
                    <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/price-sp.jpg')); ?>" alt="ウミガメのアップの画像">
                </picture>
                <!-- price リスト -->
