              ...
              <div class="contact__contents">
                  <div class="contact__body">
                      <a href="index.html" class="contact__logo">
                          <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/contact-logo.png')); ?>" alt="CodeUpsロゴ">
                      </a>
                  ...
                  <div class="contact__header">
                      ...
                      <div class="contact__button">
                          <a href="<?php echo esc_url(get_permalink(get_page_by_path('contact')->ID)); ?>" class="button">
      ...
      <div class="footer__logo-wrapper">
        ...
        <div class="footer__logo footer-logo">
            <a href="index.html" class="footer-logo__link">
                <h2 class="footer-logo__image">
                    <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/footer-logo.png')); ?>" alt="フッターロゴ">
                </h2>
            </a>
        </div>
        <!-- SNSアイコン -->
        <div class="footer__sns footer-sns">
            <a href="https://www.facebook.com/" target="_blank" class="footer-sns__link footer-sns__link--facebook">
                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/facebook-icon.png')); ?>" alt="facebookアイコン">
            </a>
            <a href="https://www.instagram.com/" target="_blank" class="footer-sns__link footer-sns__link--instagram">
                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/instagram-icon.png')); ?>" alt="instagramアイコン">
            </a>
        </div><!-- /footer__sns -->
