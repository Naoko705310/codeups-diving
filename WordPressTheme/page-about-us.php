...
<main>
    ...
    <section class="sub-fv">
        <div class="sub-fv__inner">
            ...
            <picture class="sub-fv__image">
                <source srcset="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-about-us__fv-pc.jpg')); ?>" media="(min-width: 768px)">
                <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/sub-about-us__fv-sp.jpg')); ?>" alt="シーサーの画像">
            </picture>
        </div>
    </section>
    <!-- パンくずリスト -->
    ...
    <section class="page-about-us page-layout">
        <div class="page-about-us__inner inner">
            <!-- メインメッセージ -->
            <?php if (get_field('about-us_main-copy')) : ?>
                <div class="page-about-us__contents-wrapper">
                    <div class="page-about-us__image-wrapper">
                        <figure class="about-us__image-left">
                            <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/aboutus-01.jpg')); ?>" alt="シーサーの画像" class="u-desktop">
                        </figure>
            ...
            $i = 1;
            while ($image = get_field('gallery_image' . $i)) {
                if ($image) {
